...
import { useSocket } from "../../utility/Context";
...
const Chat = (props) => {
  ...
  const user_name = useSelector((state) => state.auth.data.full_name);
  ...
  console.log("length ", chatMessages);
            ...
            <div className="col-sm-8">
              <div className="text-message">
                <div className="message-header">
                  <h5 style={{ fontWeight: "bold" }}>LALALA</h5>
                </div>
                {chatMessages.map(
